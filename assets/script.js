...
function getRandomColor() {
    let numbers_and_letters = '0123456789ABCDEF';
    let hexa = '#';
    for (let i = 0; i < 6; i++) {
        hexa += numbers_and_letters[Math.floor(Math.random() * 16)];
    }
    return hexa;
  }
...
////////////////////// Your code here //////////////////////
    ...
    // SKYBOX BACKGROUND
    {
        ...
        const texture = loader.load([
            ...
            '/assets/img/cube/right.jpg',   // RIGHT
            '/assets/img/cube/left.jpg',    // LEFT
...
////////////////////// Your code here //////////////////////
    ...
    function createGround(ground) {
        ...
        const completeGround = new THREE.Mesh(ground, groundMat);
        scene.add(completeGround);

        return completeGround;
    }
